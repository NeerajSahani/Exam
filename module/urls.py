...
urlpatterns = [
    ...
    path('<slug:slug>/question-paper/<int:pk>/responses/', faculty_views.ResponseList.as_view(),
         name='view-response-list'),
    path('<slug:slug>/question-paper/<int:paper_id>/responses/<str:username>/<int:pk>/', faculty_views.ResponseDetail.as_view(),
